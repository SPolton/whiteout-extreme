...
void ImGuiPanel::setVehicle(std::shared_ptr<VehicleFourWheelDrive> v) {
    if (!v) return;
    vehicle = v.get();
...
void ImGuiPanel::setLightingState(LightingState* lighting)
{
    lightingState = lighting;
}

void ImGuiPanel::renderLightingSettings()
{
    if (!lightingState) {
        return;
    }
